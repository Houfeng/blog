---
layout: post
title: 一个基于 Node.js 的 Web 开发框架 - Nokitjs 
category: 随笔
published: true
date: 2015-12-07
---
...
## 资源
> - GitHub [https://github.com/nokitjs/nokit](https://github.com/nokitjs/nokit) (欢迎 star)
> - 使用说明 [wiki](https://github.com/nokitjs/nokit/wiki)
> - 问题反馈 [issues](https://github.com/nokitjs/nokit/issues)
> - 主页 [http://nokit.org](http://nokit.org)
...
## 命令行工具
使用 “**命令行工具**” 时必须**全局**安装 nokitjs (全局安装的同时也可以在 app 中本地安装 nokitjs)，Nokit 应用只需在磁盘建立应用目录，并新建相关文件和目录即可， Nokit 提供了方便的命令行工具。
...
```
autostart 命令目前支持 win32 和 linux 平台，此命令需要管理员权限，如 ubuntu 需要使用 **sudo** ，
...
示例站点 [http://jser.cc](http://jser.cc) (还未全部开发完毕)
